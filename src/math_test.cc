...
class MathTest : public ::testing::TestWithParam<int> {
 ...
 protected:
  int DoMaxTest(int a, int b) { return math_lib::max(a, b); }

  int DoMinTest(int a, int b) { return math_lib::min(a, b); }
...
INSTANTIATE_TEST_CASE_P(HandleMinTest, MathValueTest,
...
INSTANTIATE_TEST_CASE_P(HandleMaxTest, MathValueTest,
                        testing::Values(1, 2, 3, 4, 5, 6, 7, 8, 9));
...
INSTANTIATE_TEST_CASE_P(HandleMinTest, MathCombineTest,
...
INSTANTIATE_TEST_CASE_P(HandleMaxTest, MathCombineTest,
                        testing::Combine(testing::Values(1, 3, 5, 7, 9),
                                         testing::Values(2, 4, 6, 8, 10)));
